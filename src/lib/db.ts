...
export const experienceCards = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Optimized the website for fast load times and smooth user experience across devices.",
    ],
  },
  {
    imgPath: chromeExtensionImage,
    workedOn: "SwiftCareer Chrome Extension",
    title: "React Developer",
    date: "January 2024 - Present",
    liveLink: 'https://chromewebstore.google.com/detail/pccfmdpadoabgffgmehogeolakhebnao?utm_source=item-share-cb',
    responsibilities: [
      "Designed and developed the SwiftCareer Chrome Extension from scratch to streamline job application tracking.",
      "Engineered the extension to detect and activate only on supported job listing websites.",
